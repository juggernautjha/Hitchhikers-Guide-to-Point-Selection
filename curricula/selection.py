...
class maxnorm_selector:
    def __init__(self, target_model : tf.keras.Model, minibatch_size : float, loss : tf.keras.losses.Loss = tf.keras.losses.categorical_crossentropy):
        self.target_model = target_model
        self.minibatch_size = minibatch_size
        self.loss = loss
